    ...
    return (
        <div className='bookshelf-game'>
            ...
            <div className='bookshelf-body'>
                <ul >
                    <li><img className="book-10" src="https://s3-us-west-2.amazonaws.com/s.cdpn.io/881020/book10.jpg" alt="The Nowhere Girls" onClick={() =>displayAlert(1)}/></li>
                    ...
                    <li><img className="book-7" src="https://s3-us-west-2.amazonaws.com/s.cdpn.io/881020/book07.jpg" alt="Der KreclassNamee Mann" onClick={() =>displayAlert(7)}/></li>
                    <li><img className="book-8" src="https://s3-us-west-2.amazonaws.com/s.cdpn.io/881020/book08.jpg" alt="Wink Poppy MclassNamenight" onClick={() =>displayAlert(8)}/></li>
